    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "key_prefix",
                    models.CharField(help_text="First 8 chars of the key for identification.", max_length=8),
                ),
                ("key_hash", models.CharField(help_text="SHA-256 hash of the full key.", max_length=64)),
                (
                    "scopes",
                    models.JSONField(
                        default=list, help_text="List of permission scopes, e.g. ['read:books', 'write:cases']."
                    ),
                ),
