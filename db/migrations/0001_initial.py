    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(blank=True, max_length=255, null=True, verbose_name="SheerID School Name"),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "accounts_id",
                    models.CharField(
                        help_text="Prioritize using Accounts_UUID__c over this for ox accounts users.", max_length=255
                    ),
                ),
                ...
                (
                    "last_modified_by",
                    models.CharField(
                        help_text="This is useful for ignoring integrations user modifications (like b2bma).",
                        max_length=255,
                    ),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "record_type_id",
                    models.CharField(blank=True, max_length=18, null=True, verbose_name="Record Type ID"),
                ),
                ...
                (
                    "amount",
                    models.DecimalField(
                        blank=True, decimal_places=2, max_digits=18, null=True, verbose_name="Savings: Current"
                    ),
                ),
                (
                    "probability",
                    models.DecimalField(
                        blank=True, decimal_places=0, default=0, max_digits=3, null=True, verbose_name="Probability (%)"
                    ),
                ),
                ...
                (
                    "book",
                    models.ForeignKey(
                        blank=True, max_length=18, null=True, on_delete=django.db.models.deletion.PROTECT, to="db.book"
                    ),
                ),
                (
                    "contact",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "opportunity",
                    models.ForeignKey(
                        max_length=18, on_delete=django.db.models.deletion.DO_NOTHING, to="db.opportunity"
                    ),
                ),
            ],
            options={
