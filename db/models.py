...
class Account(ChangeTrackingMixin, models.Model):
    ...
    assignable_status = models.CharField(max_length=255, verbose_name="Assignable Status", blank=True, null=True)
    assignable_maturity_score = models.IntegerField(verbose_name="Assignable Maturity Score", blank=True, null=True)
    assignments_created = models.IntegerField(verbose_name="Assignments Created", blank=True, null=True)
    assignments_completed = models.IntegerField(verbose_name="Assignments Completed", blank=True, null=True)
...
class Contact(ChangeTrackingMixin, models.Model):
    ...
    accounts_id = models.CharField(
        max_length=255, null=True, help_text="Prioritize using Accounts_UUID__c over this for ox accounts users."
    )
...
class Opportunity(ChangeTrackingMixin, models.Model):
    ...
    account = models.ForeignKey(
        Account, on_delete=models.PROTECT, max_length=18, verbose_name="Account ID", blank=True, null=True
    )
    ...
    stage_name = models.CharField(
        ...
        verbose_name="Stage",
        choices=[
            ("Confirmed Adoption Won", "Confirmed Adoption Won"),
            ("Closed Lost", "Closed Lost"),
            ("Unconfirmed", "Unconfirmed"),
            ("Lapsed - Book Used Previously Not Currently", "Lapsed - Book Used Previously Not Currently"),
            ("Inactive - Book No Longer in Use", "Inactive - Book No Longer in Use"),
            ("Assumed - Book Likely in Use", "Assumed - Book Likely in Use"),
            ("Active - Book Currently in Use", "Active - Book Currently in Use"),
        ],
    )
    amount = models.DecimalField(
        max_digits=18, decimal_places=2, verbose_name="Savings: Current", blank=True, null=True
    )
    probability = models.DecimalField(
        max_digits=3, decimal_places=0, verbose_name="Probability (%)", default=0, blank=True, null=True
    )
    ...
    type = models.CharField(
        ...
        choices=[
            ...
            ("Renewal - Verified", "Renewal - Verified"),
        ],
        blank=True,
        null=True,
    )
    lead_source = models.CharField(
        ...
        choices=[
            ...
            ("Renewal Popup", "Renewal Popup"),
            ("Partner Marketplace", "Partner Marketplace"),
            ("Offsite Go-To-Webinar Form", "Offsite Go-To-Webinar Form"),
            ("Website Tutor Webinar Form", "Website Tutor Webinar Form"),
            ("Offsite Creator Feast Registration Form", "Offsite Creator Feast Registration Form"),
            ("Manual List Adds", "Manual List Adds"),
            ("Website E-Newsletter Sign-Up Form", "Website E-Newsletter Sign-Up Form"),
            ("Website Institutional Partner Sign Up Form", "Website Institutional Partner Sign Up Form"),
            ("Website Contact Us Form", "Website Contact Us Form"),
            ("TSR", "TSR"),
            ("Facebook Ads", "Facebook Ads"),
            ("LinkedIn Ads", "LinkedIn Ads"),
            ("BMG Import", "BMG Import"),
    ...
    contact = models.ForeignKey(
        Contact, on_delete=models.PROTECT, max_length=18, verbose_name="Contact ID", blank=True, null=True
    )
...
class Adoption(ChangeTrackingMixin, models.Model):
    ...
    adoption_type = models.CharField(
        ...
        choices=[("Faculty/Teacher Adoption", "Faculty/Teacher Adoption"), ("School Adoption", "School Adoption")],
    )
    ...
    terms_used = models.CharField(
        max_length=255,
        verbose_name="Terms Used",
        choices=[("Fall", "Fall"), ("Spring", "Spring"), ("Both", "Both"), ("Winter", "Winter"), ("Summer", "Summer")],
        blank=True,
        null=True,
    )
    confirmation_type = models.CharField(
        ...
        default="OpenStax Confirmed Adoption",
        choices=[
    ...
    how_using = models.CharField(
        max_length=255,
        verbose_name="How Using",
        choices=[
