...
class Contact(SalesforceModel):
    ...
    last_modified_date = models.DateTimeField(
        db_column="LastModifiedDate", verbose_name="Last Modified Date", sf_read_only=READ_ONLY, blank=True, null=True
    )
    subject_interest = models.CharField(
        db_column="Subject_Interest__c", max_length=255, verbose_name="Subject Interest", blank=True, null=True
    )
