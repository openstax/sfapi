...
class Account(models.SalesforceModel):
    ...
    country_code = models.CharField(db_column="BillingCountryCode", max_length=10, default="US", blank=True, null=True)
    ...
    sheer_id_school_name = models.CharField(
        db_column="SheerID_School_Name__c", max_length=255, verbose_name="SheerID School Name", blank=True, null=True
    )
    ...
    nces_district_id2 = models.CharField(
