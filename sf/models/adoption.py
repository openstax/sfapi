...
class Adoption(models.SalesforceModel):
    contact = models.ForeignKey(
        Contact, on_delete=models.DO_NOTHING, sf_read_only=models.READ_ONLY, db_column="Opportunity__r.Contact__c"
    )
    ...
    last_activity_date = models.DateField(
        db_column="LastActivityDate", sf_read_only=models.READ_ONLY, blank=True, null=True
    )
    ...
    confirmation_type = models.CharField(
        db_column="Confirmation_Type__c",
        max_length=255,
    ...
    savings = models.DecimalField(
        db_column="Savings__c", max_digits=18, decimal_places=2, sf_read_only=models.READ_ONLY, blank=True, null=True
    )
