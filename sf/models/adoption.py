...
class Adoption(models.SalesforceModel):
    contact = models.ForeignKey(Contact, models.DO_NOTHING, db_column='Opportunity__r.Contact__c', verbose_name='Related Contact')
    adoption_number = models.CharField(db_column='Name', max_length=80, verbose_name='Adoption Number', sf_read_only=models.READ_ONLY)
    ...
    class_start_date = models.DateField(db_column='Class_Start_Date__c', verbose_name='Class Start Date')
    opportunity = models.ForeignKey(Opportunity, models.DO_NOTHING, db_column='Opportunity__c', max_length=18, verbose_name='Related Opportunity')  # References to missing tables: ['-Opportunity']
    confirmation_date = models.DateField(db_column='Confirmation_Date__c', verbose_name='Confirmation Date')
    name = models.CharField(db_column='Name__c', max_length=255, blank=True, null=True)
    base_year = models.DecimalField(db_column='Base_Year__c', max_digits=4, decimal_places=0, verbose_name='Base Year', blank=True, null=True)
    adoption_type = models.CharField(db_column='Adoption_Type__c', max_length=255, verbose_name='Adoption Type', choices=[
    ...
    terms_used = models.CharField(db_column='Terms_Used__c', max_length=255, verbose_name='Terms Used', choices=[
        ('Fall', 'Fall'),
        ('Spring', 'Spring'),
        ('Both', 'Both'),
        ('Winter', 'Winter'),
    ...
    confirmation_type = models.CharField(db_column='Confirmation_Type__c', max_length=255, verbose_name='Confirmation Type', default='OpenStax Confirmed Adoption', choices=[
    ...
    how_using = models.CharField(db_column='How_Using__c', max_length=255, verbose_name='How Using', choices=[
        ...
        ('To teach, tutor, or support students outside of a course setting', 'To teach, tutor, or support students outside of a course setting'),
        ('For my own knowledge or other work', 'For my own knowledge or other work')
    ], blank=True, null=True)
    savings = models.DecimalField(db_column='Savings__c', max_digits=18, decimal_places=2, sf_read_only=models.READ_ONLY, blank=True, null=True)
